...
@section('content')
    ...
    <img src="https://res.cloudinary.com/sergiu-adrian-ro/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,b_rgb:262c35/v1630434579/sergiu_udm9rd.jpg" alt="Sergiu Adrian, Coregraf de cuvinte." style="width:200px; border-radius:50%">
